package com.example.relations_school_management_software.Advice;
...
public class ControllerAdvice {
    ...
    // Exception  خاص ... احدد فيه المسج الي تظهر
    @ExceptionHandler(value = ApiException.class)//يرث من RunTimeException
